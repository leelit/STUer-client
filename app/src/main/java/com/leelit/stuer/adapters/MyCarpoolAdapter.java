...
public class MyCarpoolAdapter extends BaseListAdapter<MyCarpoolAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_carpool_mine, parent, false);
    ...
    private TextView getTextView(final CarpoolingInfo info, LinearLayout linearLayout) {
        TextView textView = (TextView) LayoutInflater.from(mContext).inflate(R.layout.recycler_carpool_mine_friends, linearLayout, false);
